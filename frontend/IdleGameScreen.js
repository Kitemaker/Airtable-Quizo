    ...
    const listOfNamesWithPictures =
        isValid && records
            ? getListOfNamesWithPictures({
                  records,
                  questField: settings.questFieldId,
                  opt1FieldId: settings.opt1FieldId,
                  opt2FieldId: settings.opt2FieldId,
                  opt3FieldId: settings.opt3FieldId,
                  opt4FieldId: settings.opt4FieldId,
                  
                  ansFieldId: settings.ansFieldId,
              })
            : null;
